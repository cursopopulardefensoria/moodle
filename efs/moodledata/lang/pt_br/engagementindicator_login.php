...
$string['reasonloginsperweek'] = '0% de risco por se logar à disciplina >= {$a} vezes por semana. 100% de risco para 0 logins por semana.';
$string['reasonnologin'] = 'Este usuário nunca se logou na disciplina, portanto está com o risco de 100%.';
$string['reasontimesincelogin'] = '0% de risco por ter acabo de se logar à disciplina. Escala para o máximo de 100% de risco após {$a} dias.';
