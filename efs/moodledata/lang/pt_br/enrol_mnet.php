...
$string['remotesubscriber_help'] = 'Selecione "Todos os servidores" para abrir esta disciplina para todos os pares MNET que esteja oferecendo ao serviço de inscrições remotas. Ou escolha um único provedor para tornar esta disciplina disponível para seus usuários apenas.';
