...
$string['check_guestrole_details'] = '<p>O papel visitante é utilizado para visitantes, usuários não autenticados e acesso temporário às disciplinas como visitante. Por favor, certifique-se que nenhuma ação arriscada é permitida a este papel.</p><p>O único papel legado permitido para o papel visitante é <em>Visitante</em>.</p>';
