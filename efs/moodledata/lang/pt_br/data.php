...
O layout visual de informações ao listar, visualizar ou entradas de banco de dados edição pode ser controlado por modelos de banco de dados. Atividades de banco de dados podem ser compartilhados entre as disciplinas como presets e um professor pode também importar e entradas de banco de dados de exportação.

Se o filtro de auto-linking banco de dados estiver ativado, nenhuma entrada em um banco de dados será vinculado automaticamente onde as palavras ou frases aparecem dentro da disciplina.
