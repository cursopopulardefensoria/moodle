...
$string['allowguests'] = 'Visitantes podem entrar neste disciplina';
...
$string['password_help'] = 'Uma senha permite que o acesso de visitantes à disciplina seja restrito apenas àqueles que sabem a senha. Os visitantes serão obrigadas a fornecer a senha cada vez que acessarem a disciplina.';
...
$string['pluginname_desc'] = 'O plugin para acesso como visitante apenas concede acesso temporário às disciplinas, ele não inscreve usuários.';
$string['requirepassword'] = 'Exigir senha de acesso de visitantes';
$string['requirepassword_desc'] = 'Exigir senha de acesso em novas disciplinas e evitar a remoção da senha de acesso das disciplinas existentes.';
...
$string['status_help'] = 'Esta configuração determina se um usuário pode acessar a disciplina como um visitante, sem ser obrigado a se inscrever.';
