...
$string['already_enabled'] = 'Você já tem um sistema de reserva neste disciplina.';
$string['booking_rights'] = 'Direitos de reserva';
$string['ejsappbookingname_help'] = 'Nome a ser exibido para o sistema de reservas em sua disciplina Moodle';
$string['manage_access_but'] = 'Gerenciar acesso de usuários';
$string['no_rem_labs'] = 'Não há laboratórios remotos neste disciplina';
