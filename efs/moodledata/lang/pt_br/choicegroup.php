...
/**
 * Strings for component 'choicegroup', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   choicegroup
...
$string['modulename_help'] = 'O módulo escolha um grupo permite que os estudantes inscrevam-se em um grupo dentro de uma disciplina. O professor pode selecionar quais os grupos que os alunos podem escolher e o número máximo de alunos permitidos em cada grupo.';
...
$string['option'] = 'Grupo';
$string['pleasesetgroups'] = 'Por favor, crie pelo menos dois grupos neste disciplina.';
