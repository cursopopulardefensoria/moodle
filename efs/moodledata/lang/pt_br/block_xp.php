...
$string['enablexpgain_help'] = 'Quando setado para \'Não\', ninguém ganhará pontos de experiência na disciplina. Isso é útil para congelar a experiência ganha, ou para habilitar isso por um certo período de tempo.
