...
/**
 * Strings for component 'block_pbltool', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
...
$string['map'] = 'Mapa';
$string['nogroup'] = 'Para utilizar este bloco, é necessário definir grupos neste disciplina!';
...
$string['pointing'] = 'Os alunos consideram a tarefa concluída e o professor deve analisá-la';
...
$string['recycle'] = 'Professor não estava de acordo com a tarefa e os alunos devem melhorar o planejamento';
$string['redcross'] = 'Professor não considerou a tarefa feita e os alunos devem refazer tudo';
