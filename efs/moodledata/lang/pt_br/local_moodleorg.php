...
/**
 * Strings for component 'local_moodleorg', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['downloadintro'] = 'Moodle é open source sob a <a href="http://docs.moodle.org/en/License"> licença GPL</a>. Tudo o que produzimos está disponível para você baixar e usar gratuitamente.';
...
$string['noenrolledcoursesyet'] = 'Você ainda não está inscrito em nenhum disciplina deste site.';
...
$string['supportcommercial'] = 'Os <a href="http://moodle.com/"> Parceiros Moodle (Moodle Partners)</ a> são um grupo mundial de empresas de serviço autorizado obrigadas a apoiar financeiramente o projeto de código aberto Moodle. Elas oferecem uma gama de serviços comerciais opcionais para os usuários do Moodle em todo o mundo:';
...
$string['supportforums'] = 'Nossa comunidade de usuários comunica principalmente através de fóruns nos "disciplinas" disponíveis neste site Moodle. Você precisa "inscrever-se" na disciplina para enviar mensagens aos fóruns (a inscrição é totalmente gratuita).';
...
$string['top10sitesbycourses'] = 'Top 10 sites por disciplinas';
