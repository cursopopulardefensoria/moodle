...
$string['assocdescription'] = 'Se estiver escrevendo sobre uma disciplina e/ou sobre módulos de atividades, selecione-os aqui.';
$string['associated'] = 'Associado {$a}';
$string['associatewithcourse'] = 'Blog sobre a disciplina {$a->coursename}';
$string['associatewithmodule'] = '	
Blog sobre {$a->modtype}: {$a->modname}';
$string['association'] = 'Associação';
$string['associations'] = 'Associações';
$string['associationunviewable'] = 'Esta entrada não pode ser vista por outras pessoas até que uma disciplina seja associado a ela ou o campo \'Publicar\' for modificado.';
...
$string['blogaboutthiscourse'] = 'Adicionar uma entrada sobre esta disciplina.';
...
$string['blogs'] = 'Blogs';
$string['blogscourse'] = 'Blogs da disciplina';
$string['blogssite'] = 'Blogs do site';
$string['blogtags'] = 'Tags do blog';
$string['cannotviewcourseblog'] = 'Você não tem permissões para visualizar blogs neste disciplina';
$string['cannotviewcourseorgroupblog'] = 'Você não tem permissões para visualizar blogs neste disciplina/grupo';
...
$string['configuseblogassociations'] = 'Habilita a associação de mensagens de blog com disciplinas e módulos de disciplinas';
...
$string['courseblogdisable'] = 'Os blogs de disciplina não estão habilitados';
$string['courseblogs'] = 'Os usuários podem acessar apenas os blogs de outros participantes da disciplina';
$string['deleteblogassociations'] = 'Apagar associações de blog';
$string['deleteblogassociations_help'] = 'Se selecionado, as mensagens do blog não serão mais asssociadas a esta disciplina ou a atividades ou recursos da disciplina. As mensagens não serão apagadas.';
...
$string['publishtocourse'] = 'Usuários que compartilham a disciplina com você';
$string['publishtocourseassoc'] = 'Membros da disciplina associado';
$string['publishtocourseassocparam'] = 'Membros de {$a}';
$string['publishtogroup'] = 'Usuários que compartilham seu grupo';
$string['publishtogroupassoc'] = 'Membros de seu grupo na disciplina associado';
...
$string['viewcourseblogs'] = 'Ver todas as mensagens deste disciplina';
$string['viewentriesbyuseraboutcourse'] = 'Ver mensagens sobre esta disciplina por {$a}';
...
$string['viewmyentriesaboutcourse'] = 'Ver minhas mensagens sobre esta disciplina';
