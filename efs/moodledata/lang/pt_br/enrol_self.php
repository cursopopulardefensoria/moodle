...
$string['expirymessageenrollerbody'] = 'Auto-inscrição na disciplina \'{$a->course} &quot; irá expirar en {$a->threshold} para os seguintes usuários:
...
$string['groupkey_help'] = 'Além de restringir acesso à disciplina apenas para aqueles que conhecem a chave, o uso de uma chave de inscrição de grupo faz com que os usuários sejam automaticamente incluídos ao grupo quando eles se inscrevem na disciplina.
...
$string['longtimenosee_help'] = 'Caso um usuário não tenha acessado uma disciplina por um longo período de tempo, então eles terão sua inscrição automaticamente cancelada. Este parâmetro especifica o limite de tempo';
...
$string['password_help'] = 'Uma chave de inscrição habilita para que o acesso à disciplina seja restrito apenas para quem possua a chave.
...
$string['pluginname_desc'] = 'O plugin de auto inscrição permite que usuários escolham em quais disciplinas queiram participar. As disciplinas devem ser protegidos por umachave de inscrição. Internamente a inscrição é realizada através do plugin de inscrição manual o qual deve ser habilitado no mesmo disciplina.';
...
$string['sendcoursewelcomemessage'] = 'Enviar mensagem de bem-vindos à disciplina';
$string['sendcoursewelcomemessage_help'] = 'Se habilitato os usuários recebem uma mensagem de boas vindas por email quando fazem a inscrição em uma disciplina.';
