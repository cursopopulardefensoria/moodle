...
$string['paymentrequired'] = 'Você deve efetuar um pagamento de {$a->currency} {$a->cost} pelo PagSeguro para acessar esta disciplina.';
...
$string['status_desc'] = 'Permitir que os usuários usem o PagSeguro para inscrever-se em uma disciplina por padrão.';
