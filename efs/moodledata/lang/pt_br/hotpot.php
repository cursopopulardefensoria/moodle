...
**Não**
: Apenas uma questão será adicionada à disciplina

**Sim**
: Se o arquivo-fonte é um arquivo de **Questões**, ele é tratado como o início de uma conjunto de questões e todos as questões da cadeia serão adicionadas à disciplina com configurações idênticas. Cada questão deve ter um link para o arquivo seguinte na cadeia.

Se o arquivo de origem é uma **pasta**, todas as questões reconhecíveis na pasta serão adicionadas à disciplina para formar uma cadeia de questões com especificações idênticas.

Se o arquivo de origem é um **arquivo unitário**, como um arquivo externo de Hot Potatoes ou index.html, questões contidas no arquivo serão adicionadas à disciplina como uma cadeia de questões com configurações idênticas.';
...
$string['exit_grades_text'] = 'Veja suas notas nessa disciplina até agora';
...
Normalmente, o arquivo fonte é criado fora do Moodle, e em seguida enviado para a área de arquivos de uma disciplina de Moodle. Pode ser um arquivo HTML, ou outro tipo de arquivo que foi criado com algum software de autoria, tais como o Hot Potatoes ou Qedoc.
