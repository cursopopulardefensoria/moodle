...
$string['courseexplanation'] = 'Esta ferramenta cria disciplinas de teste padrão que incluem muitas seções, atividades e arquivos. Este destina-se a fornecer uma medida padronizada para verificar a confiabilidade e o desempenho dos vários componentes do sistema (como backup e restauração). Este teste é importante porque houve muitos casos anteriores, onde, diante de casos de uso da vida real (por exemplo, uma disciplina com 1.000 atividades), o sistema não funciona. Disciplinas criados usando esse recurso podem ocupar uma grande quantidade de banco de dados e espaço em sistema de arquivos (dezenas de gigabytes). Você terá de apagar as disciplinas (e esperar por várias corridas de limpeza) para liberar esse espaço novamente. ** Não utilize esse recurso em um sistema vivo **. Use somente em um servidor desenvolvedor. (Para evitar o uso acidental, este recurso está desativado, a menos que você também tenha selecionado nível de depuração desenvolvedor.)';
...
$string['coursewithoutusers'] = 'O disciplina selecionado não tem usuários';
...
$string['error_noforumdiscussions'] = 'O disciplina selecionado não contém discussões em fórums';
$string['error_noforuminstances'] = 'O disciplina selecionado não contém instâncias do módulo forum';
$string['error_noforumreplies'] = 'O disciplina selecionado não contém respostas nos fóruns';
$string['error_nonexistingcourse'] = 'O disciplina especificado não existe';
$string['error_nopageinstances'] = 'O disciplina selecionado não contém instâncias do módulo página';
...
$string['notenoughusers'] = 'O disciplina selecionado não tem usuários suficientes';
...
É parte do tool_generator por isso funciona bem com as disciplinas gerados pelos disciplinas e os geradores de site, ele também pode ser usado com qualquer disciplina que contenha, pelo menos:
