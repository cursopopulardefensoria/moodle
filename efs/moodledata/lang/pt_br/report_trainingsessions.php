...
/**
 * Strings for component 'report_trainingsessions', language 'pt_br', branch 'MOODLE_26_STABLE'
 *
...
$string['hits'] = 'Acessos';
$string['incourses'] = 'Nos disciplinas';
...
$string['nodata'] = 'Não há dados de disciplina';
$string['nopermissiontoview'] = 'Você não tem permissões suficientes neste disciplina para ver esta informação.';
