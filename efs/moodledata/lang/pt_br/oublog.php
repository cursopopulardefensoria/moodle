...
/**
 * Strings for component 'oublog', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
 * @package   oublog
...
$string['visiblecourseusers'] = 'Visível para participantes deste disciplina';
