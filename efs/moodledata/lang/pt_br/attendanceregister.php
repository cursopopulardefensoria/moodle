...
$string['modulename_help'] = 'Registro de Presença calcula o tempo que os usuários passam trabalhando em disciplinas online. <br /> Opcionalmente permite o registro atividades offline do usuário. <br /> Dependendo do modo de rastreamento, o registro pode rastrear as atividades em um único disciplina, em todas as disciplinas da mesma categoria ou em todas as disciplinas "Meta ligados" no Disciplina que Registro de Presença esteja incluído <br />Sessões de trabalho online são calculadas com os registros de log gravados pelo Moodle. <br /> <b>Novas sessões on-line são adicionados com algum atraso pelo cron, após o logout do usuário.</b>';
...
$string['offlinespecifycourse_help'] = 'Permitir que o usuário selecione a disciplina da sessão offline relacionada. <br /> Esta opção só tem sentido se registro de presença estiver no modo de rastreamento para mais de uma disciplina(Por exemplo: mode de rastreamento "Categoria" ou "Meta-ligado")';
...
* _Todos as disciplinas na mesma categoria_: a atividade será monitorada em todos os outros disciplinas na mesma categoria da disciplina onde a instância do registro de presença foi configurada.
* _Todos as disciplinas ligados por uma disciplina meta link_: a atividade será monitorada neste disciplina em todos os outros disciplinas ligados por ligação meta disciplina.';
$string['schedule_reclalc_all_session'] = 'Agendar o recálculo das sessões';
$string['select_a_course'] = '- Selecione uma disciplina -';
$string['select_a_course_if_any'] = '- Selecione uma disciplina, se for o caso -';
...
$string['type_category'] = 'Todos as disciplinas na mesma categoria';
$string['type_course'] = 'Somente este Disciplina';
$string['type_meta'] = 'Todos os Disciplinas vinculados por Disciplina meta link';
