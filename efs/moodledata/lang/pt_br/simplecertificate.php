...
/**
 * Strings for component 'simplecertificate', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
...
$string['certificatetext_help'] = 'Este é o texto que será usado no certificado, alguns marcadores especiais serão substituídos por variáveis do certificado, como o nome das disciplinas, nome do estudante, notas...
Os marcadores são:
...
$string['emailteachermail'] = '{$a->student} recebeu o certificado: \'{$a->certificate}\' para a disciplina
{$a->course}.
...
$string['printdate_help'] = 'Esta é a data que será impressa, você pose escolher entre a data que o aluno completou a disciplina, ou a data de emissão do certificado.
...
$string['requiredtimenotmet'] = 'Você precisa ter ao menos {$a->requiredtime} minutos nessa disciplina para emitir este certificado';
