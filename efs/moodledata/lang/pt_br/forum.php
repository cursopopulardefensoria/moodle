...
$string['namenews_help'] = '<p>O fórum de notícias é um fórum especial que é automaticamente criado para cada disciplina e para a página principal do site e é um espaço para anúncios gerais. Só é possível ter um único fórum de notícias por disciplina.</p>
