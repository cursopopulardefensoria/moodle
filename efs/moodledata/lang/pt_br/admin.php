...
$string['configallowcategorythemes'] = 'Habilitando esta opção, os temas poderão ser escolhidos a nível de categoria. Isso irá afetar todas as categorias e disciplinas filhos, a não ser que eles tenham seus próprios temas. AVISO: Habilitar temas de categorias pode afetar a performance.';
...
$string['configcourserequestnotify2'] = 'Usuários que serão notificados quando uma disciplina for solicitado. Apenas usuários que podem aprovar solicitações de disciplina são listados aqui.';
...
$string['configdefaultrequestcategory'] = 'Disciplinas requisitados por usuários serão automaticamente colocados nesta categoria.';
$string['configdefaultrequestedcategory'] = 'Categoria padrão para novas disciplinas aprovados';
...
$string['confignavshowallcourses'] = 'Esta configuração determina se os usuários inscritos em disciplinas podem ver a lista com todos os Disciplinas na navegação, ao invés de apenas os Disciplinas em que estão inscritos.';
$string['confignavshowcategories'] = 'Mostra categorias de disciplinas na barra de navegação e blocos de navegação. Isso não ocorre com as disciplinas em que o usuário está inscrito, esses ainda serão listados em Minhas Disciplinas (mycourses) sem categorias.';
...
$string['configprofilesforenrolledusersonly'] = 'Para previnir o mal uso por spammers, as descrições dos perfis de usuários que ainda não estão inscritos em nenhum disciplina são escondidas. Novos usuários devem se inscrever em pelo menos uma disciplina para poderem adicionar uma descrição no perfil.';
...
$string['configrequestcategoryselection'] = 'Permitir a escolha de uma categoria ao solicitar uma disciplina.';
...
$string['configstatsuserthreshold'] = 'Esta configuração define o número mínimo de usuários inscritos em uma disciplina para ele ser incluído nos cálculos de estatísticas.';
...
$string['configvisiblecourses'] = 'Mostre disciplinas em categorias ocultas';
...
$string['coursecontact_desc'] = 'Esta opção permite que você controle quem aparece na descrição da disciplina. Usuários precisarão ter pelo menos um desses papéis em uma disciplina para serem mostrados na descrição deste disciplina.';
...
$string['coursemgmt'] = 'Gerenciar disciplinas e categorias';
...
$string['defaultrequestcategory'] = 'Categoria padrão para requisição de disciplina';
...
$string['legacyfilesaddallowed_help'] = 'Se uma disciplina tem arquivos da disciplina de legado, permitir que novos arquivos e pastas a serem adicionados a ele.';
...
$string['mnetrestore_extusers_noadmin'] = '<strong>Nota:</strong> Este arquivo de backup aparentemente foi gerado em outra instalaçao do Moodle e contém contas de usuários remotos da Rede Moodle. Você não tem autorização para executar este tipo de restauração. Contate o administrador do site ou, alternativamente, restaurar esta disciplina sem informações de usuários (módulos, arquivos...)';
...
$string['modeditingmenu_desc'] = 'Se habilitado, muitos dos ícones de edição de atividades, que são exibidos quando a edição está ligada, serão exibidos como um menu de poções. Isso reduz o conteúdo na tela ao editar uma disciplina escondendo os ícones até que eles sejam necessários.';
...
$string['navshowmycoursecategories'] = 'Exibir categorias em Minhas disciplinas';
$string['navshowmycoursecategories_help'] = 'Se habilitado, as categorias de disciplina serão exibidas em Minhas disciplinas na navegação.';
$string['navsortmycoursessort'] = 'Classificar minhas disciplinas';
$string['navsortmycoursessort_help'] = 'Isso determina se as disciplinas serão listados em Minhas disciplinas de acordo com a ordem de classificação (ou seja, a ordem definida em Configurações > Administração do Site > Gerenciar as disciplinas e categorias) ou em ordem alfabética pelo ambiente da disciplina.';
...
$string['restorernewroleid_help'] = 'Se o usuário não tiver permissão para gerenciar a disciplina recém-restaurado, ele será inscrito automaticamente receberá este papel, se necessário. Selecione "Nenhum" se você não quer que os restauradores sejam capazes de gerenciar todas as disciplinas restauradas.';
