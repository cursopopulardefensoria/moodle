...
$string['attendancenotstarted'] = 'Presença ainda não foi iniciada para esta disciplina';
...
$string['hiddensessions_help'] = 'Sessões deixam de ser visíveis se sua data é anterior à data de início da disciplina. Altere a data de início da disciplina e as sessões ocultas serão apresentadas.
...
$string['nosessionexists'] = 'Nenhuma sessão existe para esta disciplina';
