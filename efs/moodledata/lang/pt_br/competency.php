...
$string['allchildrenarecomplete'] = 'Todos os filhos estão completos';
...
$string['completeplanstask'] = 'Complete o plano de ensino devido';
$string['coursecompetencyoutcome_complete'] = 'Conclua a competência';
$string['coursecompetencyoutcome_evidence'] = 'Anexar prova';
$string['coursecompetencyoutcome_none'] = 'Fazer nada';
$string['coursecompetencyoutcome_recommend'] = 'Envie para revisão';
$string['coursemodulecompetencyoutcome_complete'] = 'Conclua a competência';
$string['coursemodulecompetencyoutcome_evidence'] = 'Anexar prova';
$string['coursemodulecompetencyoutcome_none'] = 'Fazer nada';
$string['coursemodulecompetencyoutcome_recommend'] = 'Envie para revisão';
$string['deletecompetencyratings'] = 'Excluir classificações de competência';
...
$string['errorcannotchangeapastduedate'] = 'A data de vencimento já passou; ele não pode ser alterado.';
$string['errorcannotsetduedateinthepast'] = 'A data de vencimento não pode ser definida no passado.';
$string['errorcannotsetduedatetoosoon'] = 'A data de vencimento é muito perto.';
$string['errorcompetencyrule'] = 'Regra de competência de disciplina "{$a}" desconhecida';
$string['errorcoursecompetencyrule'] = 'Regra de competência de disciplina "{$a}" desconhecida';
$string['errorinvalidcourse'] = 'Disciplina inválido.';
$string['errornocompetency'] = 'Competência {$a} não encontrada';
$string['errorplanstatus'] = 'Estado desconhecido dos planos de aprendizado \'{$a}\'';
