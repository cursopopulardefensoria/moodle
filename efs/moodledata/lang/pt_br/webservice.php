...
$string['cannotgetcoursecontents'] = 'Impossível obter conteúdos da disciplina';
...
$string['errorcoursecontextnotvalid'] = 'Você não pode executar funções no contexto da disciplina (Id da disciplina: {$a->courseid}). O erro de contexto foi: {$a->message}';
