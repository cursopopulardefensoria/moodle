...
$string['automatedminkepthelp'] = 'Se os backups forem mais antigos que um número especificado de dias serão excluídos , pode acontecer que uma disciplina inativa acaba sem backup. Para evitar isso, é necessário definir um número mínimo de backups mantidos .';
...
$string['coursecategory'] = 'Categoria em que a disciplina será restaurado';
...
$string['importsuccess'] = 'Importação concluída. Clique em Continuar para retornar à disciplina.';
...
$string['norestoreoptions'] = 'Não existem categorias ou disciplinas existentes nos quais você possa restaurar.';
...
$string['qcategory2coursefallback'] = 'A categoria de questões "{$a->name}", originalmente no contexto de sistema/disciplina no arquivo de backup, será criada no contexto de disciplina pela restauração';
$string['qcategorycannotberestored'] = 'A categoria de questões "{$a->name}" não pôde ser criada pela restauração';
$string['question2coursefallback'] = 'A categoria de questões "{$a->name}", originalmente no contexto de sistema/disciplina no arquivo de backup, será criada no contexto de disciplina pela restauração';
...
$string['restoreexecutionsuccess'] = 'O disciplina foi restaurado com sucesso, clique no botão continuar abaixo para visualizar a disciplina que você restaurou.';
...
$string['restoretocurrentcourseadding'] = 'Mesclar o conteúdo do backup com esta disciplina';
$string['restoretocurrentcoursedeleting'] = 'Excluir o conteúdo deste disciplina e restaurar o backup';
$string['restoretoexistingcourse'] = 'Restaurar em uma disciplina existente';
$string['restoretoexistingcourseadding'] = 'Mesclar o conteúdo do backup em uma disciplina existente';
$string['restoretoexistingcoursedeleting'] = 'Excluir o conteúdo de uma disciplina existente e restaurar o backup';
