...
$string['categorytype'] = 'Categorias de disciplinas';
$string['categorytypehelp'] = 'Isso permite que você selecione em quais categorias você gostaria que as disciplinas fossem criados. Opções:
<ul>
<li>Períodos: Esta configuração fará com que as disciplinas sejam colocados nas categorias com o nome do período/semestre deles.</li>
<li> Departamentos: Esta configuração fará com que as disciplinas sejam colocados em categorias com o nome do departamento que o hospeda.</li>
<li> Códigos de departamento:  Usa o código de departamento ao invés do nome completo.</li>
<li>  Períodos depois departamento? Esta configuração fará com que as disciplinas sejam colocados nas categorias com o nome do departamento que os hospeda, que está contido em um termo período com o nome dado para o período/semestre.</li>
...
<li> Selecionado: Com esta configuração, selecione a categoria existente onde você gostaria que a disciplina fosse colocado, a partir do segundo menu drop down.</li>
</ul>';
...
$string['computesectionshelp'] = 'Computar o número de sessões/tópicos para mostrar, baseado no número de semanas de uma disciplina.';
...
$string['coursehidden'] = 'Criar novas disciplinas como ocultos';
$string['coursehiddenalways'] = 'Sempre';
$string['coursehiddencron'] = 'Baseado na configuração do cron';
$string['coursehiddennever'] = 'Nunca';
$string['courseshorttitle'] = 'Nome curto da disciplina';
$string['courseshorttitlehelp'] = 'Isso contém o template para criar o nome curto da disciplina. Veja acima os tags disponíveis.';
$string['coursetitle'] = 'Nome completo da disciplina';
...
$string['cronunhidecourses'] = 'Mostrar disciplinas';
