...
$string['dedicationall'] = 'Dedicação de todos os membros da disciplina. Clique em qualquer nome para ver sua dedicação detalhada.';
...
$string['dedication:use'] = 'Permitir o uso de dedicação à disciplina';
$string['form'] = 'Configuração de dedicação à disciplina';
...
$string['userdedication'] = 'Detalhes da dedicação à disciplina de <em>{$a}</em>.';
