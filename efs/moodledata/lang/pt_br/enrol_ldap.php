...
$string['autocreate'] = '<p>Se existirem inscrições para disciplinas que ainda não foram criados no Moodle, esses disciplinas podem ser criados automaticamente .</p><p> Caso você use a criação automática de disciplina, é recomendável que você remova as seguintes capacidades:
...
$string['category'] = 'Categoria para disciplinas criados automaticamente';
...
$string['createnotcourseextid'] = 'Usuário inscrito em uma disciplina não existente \'{$a->courseextid}\'';
...
$string['pluginname_desc'] = '<p>Você pode usar um server LDAP para controlar as inscrições. Se presume que o ramo LDAP contenha grupos mapeados em relação às disciplinas e que cada um destes grupos/disciplinas terá itens que identificam membros mapeados em relação aos estudantes.</p>
