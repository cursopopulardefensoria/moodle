...
$string['errorbeforecoursestart'] = 'Não é possível criar um evento em uma data anterior à data inicial da disciplina';
...
$string['eventsrelatedtocourses'] = 'Eventos relativos às disciplinas';
...
$string['hidecourseevents'] = 'Ocultar eventos de disciplina';
...
$string['showcourseevents'] = 'Exibir eventos de disciplina';
...
$string['tt_hidecourse'] = 'Eventos da disciplina estão visíveis (clique para esconder)';
...
$string['tt_showcourse'] = 'Eventos da disciplina estão ocultos (clique para mostrar)';
