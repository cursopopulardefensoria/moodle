...
O objetivo deste questionário é fazer uma pesquisa sobre as posturas dos participantes da disciplina perante a aprendizagem e a reflexão crítica.

Cada ítem abaixo consiste em uma declaração que descreve posturas e atitudes que você pode assumir ao longo deste disciplina.
...
$string['ciqintro'] = 'Reflita sobre os eventos recentes deste disciplina para responder às próximas questões.';
...
$string['colles8'] = 'Faço reflexões críticas sobre os conteúdos da disciplina';
...
O objetivo deste questionário é fazer uma pesquisa sobre a medida em que as atividades deste disciplina favorecem o seu processo de aprendizagem.

Cada frase abaixo é uma declaração que descreve situações que podem caracterizar o seu processo de aprendizagem neste disciplina.

Reflita sobre cada declaração e, depois, selecione a opção que descreve melhor a freqüência em que as situações descritas ocorrem neste disciplina.
...
O objetivo deste questionário é fazer uma pesquisa sobre a medida em que o seu processo de aprendizagem neste disciplina corresponte às suas expectativas.

Cada ítem abaixo consiste na comparação entre as suas expectativas e a sua experiência efetiva ao freqüentar esta disciplina.

Reflita sobre cada declaração e, depois, selecione a opção que descreve melhor a freqüência em que você gostaria que as situações descritas ocorressem neste disciplina (freqüência desejada) e a freqüência em que as situações descritas ocorrem atualmente neste disciplina (freqüência atual).
...
$string['collesmintro'] = 'Neste disciplina...';
$string['collespintro'] = '<b>COMO RESPONDER AO QUESTIONÁRIO</b>

O objetivo deste questionário é fazer uma pesquisa sobre as suas expectativas em relação ao seu processo de aprendizagem neste disciplina.

Cada frase abaixo é uma declaração que descreve situações que podem caracterizar o seu processo de aprendizagem neste disciplina.

Reflita sobre cada declaração e, depois, selecione a opção que descreve melhor a freqüência em que você gostaria que as situações descritas ocorressem neste disciplina (freqüência desejada).
