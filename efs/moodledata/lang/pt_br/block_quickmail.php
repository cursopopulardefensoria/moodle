...
$string['no_course'] = 'O disciplina com id {$a} é inválido.';
...
$string['quickmail:allowalternate'] = 'Permite aos usuários adicionar e-mails alternativos (externos à disciplina) no formulário de envio de e-mails.';
