...
/**
 * Strings for component 'groupselect', language 'pt_br', branch 'MOODLE_28_STABLE'
 *
 * @package   groupselect
...
$string['cannotselectnoenrol'] = 'Você precisa estar matriculado na disciplina para tornar-se membro de um grupo.';
