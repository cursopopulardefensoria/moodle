...
/**
 * Strings for component 'tutorialbooking', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
...
$string['exportcsvlistallprompt'] = 'Exportar todas as inscrições de tutorial desse disciplina como CSV';
...
$string['indexnoid'] = 'Um disciplina id deve ser estabelecido para visualizar todos os tutoriais';
...
$string['thereareno'] = 'Não há tutoriais nessa disciplina';
...
$string['tutorialbooking:addinstance'] = 'Permite que um usuário adicione essa atividade a uma disciplina (não usado no Moodle 2.2)';
...
$string['tutorialbooking:exportallcoursetutorials'] = 'Necessário exportar lista para todas as inscrições de tutorial em uma disciplina.';
