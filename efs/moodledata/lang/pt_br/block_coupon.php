...
$string['report:status_completed'] = 'Disciplina concluído';
$string['report:status_not_started'] = 'Disciplina não iniciado ainda';
$string['report:status_started'] = 'Disciplina iniciado';
...
$string['success:coupon_used'] = 'Cupom utilizado - Agora você pode acessar o(s) disciplina(s)';
