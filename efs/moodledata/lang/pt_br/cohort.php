...
$string['removeuserwarning'] = 'A remoção de usuários de um cohort pode resultar no cancelamento da inscrição de usuários em múltiplos disciplinas o que inclui a deleção de configurações de usuários, notas, participação em grupos e outras informações das disciplinas afetados.';
...
$string['visible_help'] = 'Qualquer grupo pode ser visto por usuários que têm a permissão \'moodle/cohort:view\' no contexto coorte. Coortes visíveis também podem ser vistos por usuários nas disciplinas subjacentes.';
