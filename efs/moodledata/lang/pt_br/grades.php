...
$string['aggregateonlygraded'] = 'Apagar somente notas vazias';
...
$string['aggregatesubcatsupgradedgrades'] = 'Nota: A definição de agregação "Aggregate incluindo subcategorias" foi removida como parte de uma atualização do site. Desde "agregado incluindo subcategorias" já foi usado neste disciplina, é recomendável que você reveja esta mudança no livro de notas.';
...
$string['aggregationposition_help'] = 'Esta opção define se as colunas da categoria da disciplina e total da disciplina serão mostradas no começo ou no fim dos relatórios do livro de notas.';
...
$string['coursegradecategory'] = 'Categoria de notas da disciplina';
...
$string['gradebookcalculationswarning'] = 'Nota: Alguns erros foram detectados no cálculo das notas apresentadas no livro de notas. Se sua disciplina não começou ou está em andamento, recomenda-se que os erros sejam corrigidos clicando no botão abaixo, embora isso resultará na alteração de algumas notas. Se sua disciplina já foi encerrado e as notas enviadas, você provavelmente não quer corrigir o erro.
...
$string['gradecategoryonmodform_help'] = 'Selecione a categoria de notas do livro de notas à qual esta atividade estará subordinada. Esta escolha tem impacto sobre a forma como as notas da atividade serão agregadas com as notas de outras atividades para compor a nota final da disciplina. Esta categoria pode ser alterada posteriormente, tanto aqui como diretamente no livro de notas.';
...
$string['importcustom'] = 'Importar como resultados customizados (somente nessa disciplina)';
...
$string['includescalesinaggregation_help'] = 'Você pode mudar se as escalas devem ser incluídas como números em todas as notas agregadas de todos os livros de notas de todas as disciplinas.
...
$string['no'] = 'Não';
$string['nocategories'] = 'Não foi possível encontrar ou adicionar categorias de nota neste disciplina';
...
$string['nooutcomes'] = 'Os itens de resultados devem apontar para o resultado de uma disciplina, mas não há resultados para esse disciplina. Deseja acrescentar um?';
...
$string['outcome'] = 'Meta';
$string['outcomeassigntocourse'] = 'Atribuir um outro resultado para esta disciplina';
...
$string['outcomestandard_help'] = '<p>Um Resultado padrão fica disponível a nível do site, para todas as disciplinas.</p>';
...
$string['recovergradesdefault_help'] = 'Por padrão recuperar notas antigas ao reinscrever um aluno em uma disciplina';
...
$string['setcategorieserror'] = 'É necessário definir categorias para o sua disciplina antes de atribuir pesos às mesmas.';
...
$string['weight'] = 'Peso';
$string['weightcourse'] = 'Usar médias ponderadas nessa disciplina';
...
$string['weight_help'] = 'Valor usado para determinar o valor relativo dos vários itens de nota de uma categoria ou disciplina.';
