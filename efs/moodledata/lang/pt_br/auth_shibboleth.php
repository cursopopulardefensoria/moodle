...
$string['auth_shib_contact_administrator'] = 'No caso de você não estão associadas com as organizações dadas e você precisa ter acesso a uma disciplina sobre este servidor, por favor entre em contato com o <a href="mailto:{$a}">Administrador do Moodle</a> .';
