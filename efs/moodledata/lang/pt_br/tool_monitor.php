...
$string['cachedef_eventsubscriptions'] = 'Este armazena a lista de assinaturas de eventos para disciplinas individuais';
...
$string['selectacourse'] = 'Escolher uma disciplina';
$string['selectcourse'] = 'Visite este relatório no nível disciplina para obter uma lista de possíveis módulos';
