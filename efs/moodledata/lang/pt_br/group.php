...
$string['enrolmentkey_help'] = 'O uso de um código de inscrição em grupo habilita o usuário que o conheça a ter acesso à disciplina, ao mesmo tempo que o inscreve automaticamente no grupo correspondente.

Para esta opção ter efeito é necessário habilitar o \'método de autoinscrição\' na disciplina e nele selecionar a opção \'Usar códigos de inscrição de grupo\' e, também, definir um \'código de inscrição\' para a disciplina em si (este código habilita acesso à disciplina, sem inscrever o usuário em grupos). Apesar de serem definidos dois códigos de inscrição distintos, o usuário precisa conhecer apenas um deles, conforme a intenção do professor (apenas inscrever na disciplina ou simultaneamente inscrevê-lo num grupo).';
...
$string['grouping_help'] = 'O agrupamento é uma coleção de grupos dentro de uma disciplina. Se um agrupamento é selecionado, os alunos associados aos grupos desse agrupamento poderão trabalhar juntos.';
$string['groupingname'] = 'Nome do agrupamento';
$string['groupingnameexists'] = 'O nome do agrupamento \'{$a}\' já existe nessa disciplina, por favor escolha outro.';
$string['groupings'] = 'Agrupamentos';
$string['groupingsection'] = 'Permitir acesso somente ao agrupamento';
$string['groupingsection_help'] = 'Um agrupamento é uma coleção de grupos em uma disciplina. Se um agrupamento for selecionado aqui, somente alunos membros de grupos que fazem parte desse agrupamento terão acesso a esse tópico.';
...
$string['groupnameexists'] = 'O nome de grupo \'{$a}\' já existe nessa disciplina, por favor escolha outro.';
...
$string['nogroups'] = 'Ainda não há grupos definidos nessa disciplina';
