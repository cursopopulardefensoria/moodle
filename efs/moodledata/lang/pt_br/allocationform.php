...
$string['noallocationforms'] = 'Formulários de atribuição não encontrados para esta disciplina';
...
$string['roleselect_help'] = 'Selecione o papel dos utilizadores sobre esta disciplina que será atribuído através deste formulário.';
$string['saved'] = 'Opções salvas, você pode agora retornar à disciplina';
