...
$string['type_format'] = 'Formato de disciplina';
$string['type_format_plural'] = 'Formatos de disciplina';
...
$string['uninstallextraconfirmmod'] = 'Há {$a->instances} instâncias desse módulo em {$a->courses} disciplinas.';
