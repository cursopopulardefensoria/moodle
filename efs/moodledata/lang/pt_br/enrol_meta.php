...
$string['coursesort_help'] = 'Isso determina se a lista de disciplinas que podem ser vinculadas são classificadas por ordem de classificação (ou seja, a ordem estabelecida no local de administração> Disciplinas> Gerenciar as disciplinas e categorias) ou em ordem alfabética por definição.';
