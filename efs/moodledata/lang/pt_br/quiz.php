...
$string['addingquestions'] = 'Neste lado da página você administra a sua base de dados de questões. As questões são organizadas em categorias e podem ser usadas por qualquer questionário deste disciplina ou de outros disciplinas.
...
$string['publishedit'] = 'Você deve ter direitos de publicação de disciplinas para adicionar ou editar questões nesta categoria';
$string['qbrief'] = 'Q. {$a}';
$string['qname'] = 'nome';
