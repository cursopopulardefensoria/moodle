...
$string['deleteinstanceconfirmself'] = 'Você tem certeza que deseja excluir instância "{$a->name}", que dá acesso a esta disciplina? É possível que você não seja capaz de acessar esta disciplina, se você continuar.';
...
$string['disableinstanceconfirmself'] = 'Você tem certeza que deseja desativar instância "{$a->name}", que dá acesso a esta disciplina? É possível que você não seja capaz de acessar esta disciplina, se você continuar.';
...
$string['instanceeditselfwarningtext'] = 'Você está matriculado neste disciplina através deste método de inscrição, alterações podem afetar seu acesso a esta disciplina.';
...
$string['noguestaccess'] = 'Visitantes não podem acessar esta disciplina. Por favor faça login.';
$string['none'] = 'Nenhum';
...
$string['rolefromcategory'] = '{$a->role} (Herdado da categoria da disciplina)';
