...
$string['createnewcategories'] = 'Criar novas categorias de disciplinas (ocultas) se não forem encontradas no Moodle';
$string['createnewcategories_desc'] = '<p>Se o elemento &lt;org&gt;&lt;orgunit&gt; está presente na informação de entrada de uma disciplina, seu conteúdo será usado para especificar uma categoria quando a disciplina for criado.</p>
...
$string['createnewcourses_desc'] = '<p>O plugin de inscrição IMS Enterprise pode criar novas disciplinas para qualquer um que ele encontrar nos dados do IMS, mas não no banco de dados do Moodle, se essa configuração estiver ativada</p>
